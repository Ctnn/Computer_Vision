...
#Set The Width and Heights That Are Needed for input into Our Model
inWidth=300
inHeight=300
WHRatio=inWidth/float(inHeight)

#These are needed for oru preproccesing of our image

inScaleFactor=0.007843
meanVal=127.5

#Point to the paths of our weights and model architecture in a protocol
